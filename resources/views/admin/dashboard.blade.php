    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-12 grid-margin">
          <div class="row">
            <div class="col-12 col-xl-5 mb-4 mb-xl-0">
              <h4 class="font-weight-bold">Bienvenu {{Auth::user()->name}}!</h4>
              <h4 class="font-weight-normal mb-0">Dashboard,</h4>
            </div>
            <div class="col-12 col-xl-7">
              <div class="d-flex align-items-center justify-content-between flex-wrap">
                <div class="border-right pr-4 mb-3 mb-xl-0">
                  <p class="text-muted">Inscript</p>
                  <h4 class="mb-0 font-weight-bold"><a href="">liste</a></h4>
                </div>
                <div class="border-right pr-4 mb-3 mb-xl-0">
                  <p class="text-muted">Apprenant</p>
                  <h4 class="mb-0 font-weight-bold"><a href="">liste</a></h4>
                </div>
                <div class="border-right pr-4 mb-3 mb-xl-0">
                  <p class="text-muted">Inpayer</p>
                  <h4 class="mb-0 font-weight-bold"><a href="">liste</a></h4>
                </div>
                <div class="pr-3 mb-3 mb-xl-0">
                  <p class="text-muted">Newspaper</p>
                  <h4 class="mb-0 font-weight-bold"><a href="{{route('newspaper.all')}}">liste</a></h4>
                </div>
                <div class="mb-3 mb-xl-0">
                  <button class="btn btn-warning rounded-0 text-white"><a href="{{route('notificationMarketing')}}" style="color: white">Envoi email</a></button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title text-md-center text-xl-left">Nombre d'inscript</p>
        ...
        <div class="col-md-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title text-md-center text-xl-left">Nombre d'apprenant</p>
              <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
        ...
        <div class="col-md-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title text-md-center text-xl-left">nombre s'impayer</p>
              <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
        ...
        <div class="col-md-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title text-md-center text-xl-left">Nombre newspaper</p>
              <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
