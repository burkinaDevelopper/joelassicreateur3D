...
<section class="breadcrumbs-custom bg-image" style="background-image: url({{asset('assets/images/exterieur-banner.png')}});">
    <div class="shell">
      <h1 class="breadcrumbs-custom__title">Rendu D'exterieur</h1>
      <ul class="breadcrumbs-custom__path">
        <li class="active">Vue paranomique</li>
      </ul>
    </div>
</section>
    ...
    <div class="shell">
      <div class="range range-50 range-sm-center range-md-left"> 
        <div class="cell-sm-6 cell-md-5">
          <div class="thumb-bordered"><img src="{{$rendu4->url}}" alt="" width="437" height="435"/>
          </div>
        </div>
        <div class="cell-sm-6 cell-md-7">
          <div class="box-width-3 box-centered">
            <article class="quote-big">
              <p class="q">Expert en design d'exterieur.</p>
            </article>
            <div class="divider"></div>
            <p class="text-spacing-05">Joel, formateur émérite en rendu extérieur 3D, incarne la fusion parfaite entre passion artistique et maîtrise technique.Rejoignez moi pour transcender vos compétences et donner vie à vos projets de design d'extérieur avec une créativité exceptionnelle</p>
            <div class="group-3-columns" data-lightgallery="group">
              <div class="column-item"><a class="thumb-light" href="{{$rendu4->url}}" data-lightgallery="item">
                <img src="{{$rendu4->url}}" alt="" width="120" height="171"/>
                  <div class="thumb-light__overlay"></div></a></div>
              <div class="column-item"><a class="thumb-light" href="{{$rendu5->url}}" data-lightgallery="item">
                <img src="{{$rendu5->url}}" alt="" width="120" height="171"/>
                  <div class="thumb-light__overlay"></div></a></div>
              <div class="column-item"><a class="thumb-light" href="{{$rendu6->url}}" data-lightgallery="item" >
                <img src="{{$rendu6->url}}" alt="" width="120" height="171"/>
                  <div class="thumb-light__overlay"></div></a></div>
            </div>
          </div>
        </div>
...
<section class="section section-sm bg-gray-lighter text-center">
    <div class="shell">
      <div class="range range-50 range-sm-center">
        <div class="cell-md-10 cell-lg-9">
          ...
          <p>Vous rêvez de maîtriser l'art de la visualisation extérieur et de donner vie à des espaces époustouflants en trois dimensions ? Ne cherchez pas plus loin ! Notre Formation Avancée en Rendu extérieur 3D, dirigée par des experts chevronnés, vous offre l'opportunité unique de perfectionner vos compétences dans le domaine du design d'intérieur virtuel.</p>
        </div>
      </div>
    </div>
    <!-- Owl Carousel-->
    <div class="owl-carousel-wrap owl-carousel_style-2">
       <div class="owl-carousel" data-items="1" data-autoplay="true" data-lg-items="3" data-dots="false" data-nav="true"     data-stage-padding="0" data-xs-stage-padding="90" data-sm-stage-padding="140" data-md-stage-padding="260"    data-lg-stage-padding="1" data-loop="true" data-margin="0" data-mouse-drag="false" data-nav-custom="#owl-carousel-nav" data-center-mode="true" data-speed="500" data-lightgallery="group">
        @forelse ($renduExterieurs as $renduExterieur)
            
        
        <a class="thumb-ruby thumb-mixed_large" href="{{$renduExterieur->url}}" data-lightgallery="item">
          <img class="thumb-ruby__image" src="{{$renduExterieur->url}}" alt="{{$renduExterieur->title}}" width="649" height="427"/>
          <div class="thumb-ruby__caption">
            <p class="thumb-ruby__title heading-3">{{$renduExterieur->title}}</p>
            <p class="thumb-ruby__text">{{$renduExterieur->description}}</p>
          </div>
        </a>
        @empty
...
<section class="section parallax-container bg-image-dark" data-parallax-img="{{asset('assets/images/exterieur-contact.png')}}">
