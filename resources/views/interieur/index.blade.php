...
<section class="breadcrumbs-custom bg-image" style="background-image: url({{asset('assets/images/interieur-banner.png')}});">
    <div class="shell">
      <h1 class="breadcrumbs-custom__title">Rendu D'interieur</h1>
    ...
    <div class="shell">
      <div class="range range-50 range-sm-center range-md-left"> 
        <div class="cell-sm-6 cell-md-5">
          <div class="thumb-bordered"><img src="{{$rendu1->url}}" alt="" width="437" height="435"/>
          </div>
        </div>
        <div class="cell-sm-6 cell-md-7">
          <div class="box-width-3 box-centered">
            <article class="quote-big">
              <p class="q">Expert en design d'intérieur.</p>
            </article>
            ...
            <div class="group-3-columns" data-lightgallery="group">
              <div class="column-item"><a class="thumb-light" href="{{$rendu1->url}}" data-lightgallery="item">
                <img src="{{$rendu1->url}}" alt="" width="120" height="171"/>
                  <div class="thumb-light__overlay"></div></a></div>
              <div class="column-item"><a class="thumb-light" href="{{$rendu2->url}}" data-lightgallery="item">
                <img src="{{$rendu2->url}}" alt="" width="120" height="171"/>
                  <div class="thumb-light__overlay"></div></a></div>
              <div class="column-item"><a class="thumb-light" href="{{$rendu3->url}}" data-lightgallery="item" >
                <img src="{{$rendu3->url}}" alt="" width="120" height="171"/>
                  <div class="thumb-light__overlay"></div></a></div>
            </div>
          </div>
        </div>
...
<section class="section section-sm bg-gray-lighter text-center">
    ...
    <div class="owl-carousel-wrap owl-carousel_style-2">
       <div class="owl-carousel" data-items="1" data-autoplay="true" data-lg-items="3" data-dots="false" data-nav="true"     data-stage-padding="0" data-xs-stage-padding="90" data-sm-stage-padding="140" data-md-stage-padding="260"    data-lg-stage-padding="1" data-loop="true" data-margin="0" data-mouse-drag="false" data-nav-custom="#owl-carousel-nav" data-center-mode="true" data-speed="500" data-lightgallery="group">
        @forelse ($renduInterieurs as $renduInterieur)
            
        
        <a class="thumb-ruby thumb-mixed_large" href="{{$renduInterieur->url}}" data-lightgallery="item">
          <img class="thumb-ruby__image" src="{{$renduInterieur->url}}" alt="{{$renduInterieur->title}}" width="649" height="427"/>
          <div class="thumb-ruby__caption">
            <p class="thumb-ruby__title heading-3">{{$renduInterieur->title}}</p>
            <p class="thumb-ruby__text">{{$renduInterieur->description}}</p>
          </div>
        </a>
        @empty
...
<section class="section parallax-container bg-image-dark" data-parallax-img="{{asset('assets/images/desing-interieur-1919x1225.png')}}">
